...
function Logo() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
      ...
      <span style={{ fontWeight: 700, fontSize: '16px', letterSpacing: '-0.03em', color: 'var(--accent)' }}>
        FaceGate
      </span>
    </div>
  )
    ...
    <div style={{ minHeight: '100vh', display: 'flex', background: 'var(--bg)' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBottom: '8px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
        ...
        <div style={{ padding: '32px' }}>
          ...
          {activeTab === 'overview' && (
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '32px' }}>
                {[
                  { label: 'API Status', value: apiKey ? 'Active' : 'No key yet', color: apiKey ? 'var(--success)' : 'var(--text-muted)' },
                  { label: 'Enrollments', value: '—', color: 'var(--text-primary)' },
                  { label: 'Blocked attempts', value: '—', color: 'var(--text-primary)' },
                ].map(stat => (
              ...
              {!apiKey && (
                <div style={{
                  ...
                  <div>
                    <div style={{ fontSize: '15px', fontWeight: '600', color: 'var(--accent)', marginBottom: '4px' }}>Get your API key</div>
                    <div style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>Generate your key to start protecting subscriptions</div>
                  </div>
                  <button
            ...
            <div style={{ maxWidth: '580px' }}>
              ...
              {!apiKey ? (
                <div style={{
                  ...
                  <div style={{ fontSize: '15px', fontWeight: '600', marginBottom: '16px' }}>Generate API Key</div>
                  ...
                  <button
                    ...
                    style={{
                      background: appName.trim() ? 'var(--accent)' : 'var(--border)',
                ...
                <div>
                  <div style={{
                    ...
                    <div style={{ fontSize: '13px', color: 'var(--text-muted)', marginBottom: '8px' }}>Your API Key</div>
            ...
            <div style={{ maxWidth: '640px' }}>
              ...
              {[
                ...
                <div key={item.step} style={{
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontSize: '14px', fontWeight: '600', marginBottom: '8px' }}>{item.title}</div>
                    <div style={{
          ...
          {activeTab === 'docs' && (
            <div style={{ maxWidth: '580px' }}>
              ...
              {[
                { title: 'GitHub Repository', desc: 'Source code, issues, and contributions', href: 'https://github.com/omsant02/FaceGate' },
                { title: 'npm Package', desc: '@facegate/sdk — install and integrate', href: 'https://npmjs.com/package/@facegate/sdk' },
                { title: 'World ID Selfie Check', desc: 'How the underlying verification works', href: 'https://docs.world.org/world-id/credentials/11' },
              ].map(doc => (
                <a key={doc.title} href={doc.href} target="_blank" style={{ textDecoration: 'none' }}>
                  <div style={{
                    ...
                    <div>
                      <div style={{ fontSize: '14px', fontWeight: '600', color: 'var(--text-primary)', marginBottom: '3px' }}>{doc.title}</div>
